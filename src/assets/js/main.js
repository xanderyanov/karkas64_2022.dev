$(function () {
  ...
  if ($('.ig__area').length) {
    $("#instafeed").length ? (a = new Instafeed({
      ...
      template: '<div class="ig__item"><a class="ig__link" href="{{link}}" target="_blank" style="background-image: url({{image}});"><img src="assets/img/igcanvas.png" alt="{{caption}}"/></a></div>'
    }), a.run()) : void 0;
  }
...
var share_title = 'Сайты в Энгельсе';
...
if ($(".map__area").length) {
  ...
  function init() {
    ...
    myGeoObjects[0] = new ymaps.Placemark([51.467929973539924, 46.101787816399735], {
